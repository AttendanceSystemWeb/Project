                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {classes.map((cls) => (
                    <tr key={cls.id} className="hover:bg-gray-50">
                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{cls.class_name}</td>
                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-600 whitespace-nowrap">{cls.class_code}</td>
