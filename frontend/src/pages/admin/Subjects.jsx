                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {subjects.map((subject) => (
                    <tr key={subject.id} className="hover:bg-gray-50">
                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{subject.subject_name}</td>
                      <td className="px-3 sm:px-6 py-4 text-sm text-gray-600 whitespace-nowrap">{subject.subject_code}</td>
